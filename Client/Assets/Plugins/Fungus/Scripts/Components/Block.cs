...
namespace Fungus
{
    ...
    public class Block : Node
    {
        ...
        public void InsertCommand(Command command,bool select = false)
        {
            var flowchart = GetFlowchart();
        ...
        public void RefreshBlockPos(Vector2 position)
        {
            _NodeRect = new Rect(position.x, position.y, 0, 0);
        }

        public Vector2 GetBlockPos()
        {
            return new Vector2(_NodeRect.x, _NodeRect.y);
        }
        #endregion
    }
}
