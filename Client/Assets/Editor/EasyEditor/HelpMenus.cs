...
{
    [MenuItem("Help/Open Streaming Folder", priority = 148)]
    public static void OpenFolderStreamingAssetsPath()
    {
        EditorUtility.RevealInFinder(Application.streamingAssetsPath);
    }

    [MenuItem("Help/Open Cache Folder", priority = 149)]
    public static void OpenTemporaryCacheFolder()
    {
        EditorUtility.RevealInFinder(Application.temporaryCachePath);
    }

    [MenuItem("Help/Open Log Folder", priority = 150)]
    public static void OpenConsoleLogFolder()
    {
    ...
    public static void OpenRegisterPath()
    {
        ...
        string registryLocation = @"HKEY_CURRENT_USER\Software\Unity\UnityEditor\" + Application.companyName + @"\" +
