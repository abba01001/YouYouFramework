...
public class LanuchScene
{
    ...
    //     Menu.SetChecked("启动场景/AI模拟器", true);
    //     Menu.SetChecked("启动场景/关卡编辑器", false);
    //     Menu.SetChecked("启动场景/手动选择", false);
    //     SceneAsset scene = AssetDatabase.LoadAssetAtPath<SceneAsset>("Assets/Scenes/AIScene.unity");
    //     EditorSceneManager.playModeStartScene = scene;
    // }
    //
    // [MenuItem("启动场景/关卡编辑器")]
    // static void LevelScene()
    // {
    //     Menu.SetChecked("启动场景/游戏", false);
    //     Menu.SetChecked("启动场景/AI模拟器", false);
    //     Menu.SetChecked("启动场景/关卡编辑器", true);
    //     Menu.SetChecked("启动场景/手动选择", false);
    //     SceneAsset scene = AssetDatabase.LoadAssetAtPath<SceneAsset>("Assets/Scenes/EditorScene.unity");
    //     EditorSceneManager.playModeStartScene = scene;
    // }
