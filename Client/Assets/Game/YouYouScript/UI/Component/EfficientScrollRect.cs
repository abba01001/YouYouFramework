...
using UnityEngine.UI;
    ...
    public class EfficientScrollRect : ScrollRect
    {
        ...
        public int LineSpace { set => lineSpace = value; }
        ...
        private void CreateItem(int index)
        {
            ...
            {
                itemBase = Instantiate(itemPrefab).GetComponent<ScrollItem>();// GameObjManager.Instance.PopGameObject(objType, itemPrefab).GetComponent<ScrollItem>();
