...
{
    [ReadOnly] public string HuoBiType;
...
public class GoldPanel : MonoBehaviour
{
    ...
    [SerializeField] private List<ButtonData> btnList = new List<ButtonData>();

    private Dictionary<string, ButtonData> btnDic = new Dictionary<string, ButtonData>();
