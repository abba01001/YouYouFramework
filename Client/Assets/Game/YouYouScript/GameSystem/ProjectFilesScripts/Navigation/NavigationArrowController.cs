...
namespace Watermelon
{
    ...
    public class DirecitonPointersController
    {
        ...
        {
            arrowPointerPool = new Pool(arrowDirectionPointerPrefab, "Arrow Pointer");

            arrowLinePointerPool = new Pool(arrowsLineDirectionPointerPrefab, "Arrow Line Pointer");
        ...
        public void Unload()
        {
            if(!activePointers.IsNullOrEmpty())
            {
                foreach (BaseDirectionPointerCase pointer in activePointers)
                {
                    pointer.Disable();
                }
            ...
            arrowPointerPool?.Destroy();
            arrowLinePointerPool?.Destroy();
        }
