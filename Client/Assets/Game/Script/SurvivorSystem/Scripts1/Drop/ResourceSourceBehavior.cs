            ...
            for (int i = harvestStages.Count - 1; i >= 0; i--)
            {
                ...
                if (stage.HealthThreshold >= Health)
                {
                    ...
                    for (int j = 0; j < stage.Drop.Count; j++)
                    {
                        ...
                        Currency currency = CurrencyController.GetCurrency(dropRes.currency);
                        ...
                        for (int d = 0; d < steps; d++)
                        {
                            ...
                            if (drop)
                            {
                                ...
                                dropResource.Initialise(amountPerStep).SetDropAnimation(dropAnimation).SetDisableTime(30);
                                ...
                                dropResource.Throw(transform, stage.gameObject.transform.position, hitSourcePosition);
                            }
                        }
                    }
                }
