...
namespace Watermelon
{
        ...
        IResourceTaker, IHitter
    {
        ...
        public void Initialise()
        {
            ...
            playerGraphicsHolder.Initialise(this, playerSkinData.Prefab);
        ...
        {
            CurrencyController.Substract(resource.currency, resource.amount);
        ...
        {
            return CurrencyController.Get(currencyType);
        }
        ...
        public void TakeResource(FlyingResourceBehavior flyingResource, bool fromPlayer = false)
        {
            ...
            var tweenCase = flyingResource.PlayAnimation(FlyingResourceDestination, () =>
            {
                ...
                CurrencyController.Add(flyingResource.ResourceType, flyingResource.Amount);
                inventory.RecalculateCapacity();
        ...
        public void OnResourcePickPerformed(ResourceDropBehavior dropBehavior)
        {
            ...
            if (currency != null)
            {
                ...
                {
                    CurrencyController.Add(currency.CurrencyType, dropBehavior.DropAmount);
        ...
        public bool CanTakeResource(ref Resource resource)
        {
        ...
        {
            public FloatingTextBaseBehavior floatingText;
            public int amount;
        }
    }
}