...
{
    [CreateAssetMenu(fileName = "Weather Preset", menuName = "Data/Weather/Weather Preset")]
    public class EnvironmentWeatherPreset : ScriptableObject
    {
        ...
        [Header("Fog")]
        [SerializeField] bool fogEnabled = false;
        ...
        [SerializeField, ShowIf("IsFogModeLinear")] DuoFloat fogRange = new DuoFloat(30, 50);
        public DuoFloat FogRange => fogRange;
        ...
        public float GetShadowsMultiplier(float shadows)
        {
            ...
            {
                case Blending.Additive:
                    return shadows + shadowsIntensity;
                case Blending.Subtract:
                    return shadows - shadowsIntensity;
                case Blending.Override:
        ...
        public Color SampleSkyGradient(Color color, float t)
        {
            ...
            {
                case Blending.Additive:
                    return (color + skyColor).SetAlpha(color.a);
                case Blending.Subtract:
                    return (color - skyColor).SetAlpha(color.a);
                case Blending.Override:
                    return skyColor;
