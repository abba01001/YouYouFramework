...
//将 Base64 字符串转换为二进制数据
        ...
        try
        {
            ...
            foreach (var property in properties)
            {
                ...
                Debugger.LogError($"设置{property.Name}======={value}");
        ...
        {
            Debugger.LogError($"初始化失败 {ex.Message}===》用默认值");
        }
    ...
    public async UniTask LoadLoginBg()
    {
        ...
        //     Debugger.LogError(bgImage == null,"===",sprite == null);
