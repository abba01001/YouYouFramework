...
namespace GameScripts
{
    ...
    public static class StringBuilderExtension
    {
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder AppendFormat3StringSlice(this StringBuilder sb, string format, StringSlice arg0,
            StringSlice arg1, StringSlice arg2)
        {
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder AppendFormatNoGC_Int_String(this StringBuilder sb, string format, int arg0,
            String arg1)
        {
            sb.Clear();
            sb.Append(format);
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder AppendFormatNoGC_String_Int(this StringBuilder sb, string format, String arg0,
            int arg1)
        {
            sb.Clear();
            sb.Append(format);
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder AppendFormatNoGC_String_String(this StringBuilder sb, string format, String arg0,
            String arg1)
        {
            sb.Clear();
            sb.Append(format);
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder AppendFormatNoGCStringSlice(this StringBuilder sb, string format,
            List<StringSlice> lss)
        {
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder ReplaceNoGC(this StringBuilder sb, string oldValue, string newValue, int startIndex,
            int count)
        {
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder ReplaceNoGC(this StringBuilder sb, StringBuilder oldValue, string newValue,
            int startIndex, int count)
        {
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static StringBuilder SubStringBuilder(this StringBuilder sb, StringBuilder from, int startIndex,
            int count)
        {
            if (null == from)
            {
        ...
        /// 仅允许在主线程中使用
        /// </summary>
        public static int IndexOf(this StringBuilder sb, StringBuilder value, int startIndex = 0,
