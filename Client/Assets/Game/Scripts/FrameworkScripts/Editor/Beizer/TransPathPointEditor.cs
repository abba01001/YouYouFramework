...
public class TransPathPointEditor : Editor
{
    ...
    public static void DrawTangentHandles(TransPathPoint pathPoint)
    {
        ...
        var fmh_45_83_638972661396549449 = Quaternion.identity; Vector3 startTangent = Handles.FreeMoveHandle(pathPoint.startTangent, HandleUtility.GetHandleSize(pathPoint.startTangent) * 0.15f, Vector3.zero, Handles.SphereHandleCap);
        ...
        var fmh_56_79_638972661396560697 = Quaternion.identity; Vector3 endTangent = Handles.FreeMoveHandle(pathPoint.endTangent, HandleUtility.GetHandleSize(pathPoint.endTangent) * 0.15f, Vector3.zero, Handles.SphereHandleCap);
