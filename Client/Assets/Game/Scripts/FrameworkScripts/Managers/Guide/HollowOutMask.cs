...
namespace GameScripts
{
    ...
    public class HollowOutMask : Graphic, ICanvasRaycastFilter
    {
    	...
    	[Header("镂空区域")] [Space(25)] public RectTransform inner_trans;
    
    	[Header("是否实时刷新")] [Space(25)] public bool realtimeRefresh = false;
    
    	/// <summary>
    	/// 是否穿透点击
    	/// </summary>
    	[HideInInspector] public bool IsAcross = true;
