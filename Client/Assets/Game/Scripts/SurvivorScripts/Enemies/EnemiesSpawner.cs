...
namespace OctoberStudio
{
    ...
    public class EnemiesSpawner : MonoBehaviour
    {
        ...
        public virtual void Init(PlayableDirector director)
        {
            ...
            var waves = director.GetSortAssets<WaveTrack, WaveAsset>();
            ...
            {
                enemiesDiedCounter = GameEntry.Data.StageSaveData.enemiesKilled;
            }
            
            GameEntry.Event.Dispatch(Constants.EventName.RefreshKilledEnemiesCount,enemiesDiedCounter);
        }
        ...
        public virtual void KillEveryEnemy()
        {
            ...
            GameEntry.Data.StageSaveData.SetStageEnemiesKilled(enemiesDiedCounter);
            enemies.Clear();
        }
