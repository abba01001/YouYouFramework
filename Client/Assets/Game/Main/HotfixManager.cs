...
namespace Main
{
    public class HotfixManager
    {
        ...
        public void Init()
        {
            ...
            // WebGL 平台直接给默认值，完全绕过底层网络 API
            LocalServerUrl = "127.0.0.1:17888";
            LocalAssetUrl = $"http://127.0.0.1:8000/{Application.platform}/{Application.version}";
            LocalVersionUrl = $"http://127.0.0.1:8000/{Application.platform}";
#else
