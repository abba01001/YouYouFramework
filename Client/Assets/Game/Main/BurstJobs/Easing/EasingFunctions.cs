...
namespace Main
{
    // 移除类顶部的 #if UNITY_EDITOR，确保真机也能进入 Burst 编译
    [BurstCompile]
    public static class EasingFunctions
    {
        ...
        {
            // 2. 移除 #if UNITY_EDITOR。Burst 在打包时会自动将这些函数静态编译。
            // 只要是在 AOT 程序集下，打包后这些指针在手机上是合法的。
        ...
        // 3. 这里的 ApplyEasing 建议也加上 [BurstCompile]，提高分支预测效率
        [BurstCompile]
        ...
        // --- 以下所有具体算法保持不变，但确保 [BurstCompile] 和 [MethodImpl] 存在 ---
        ...
        public static float BounceOut(float t)
        {
            ...
            if (t < 8 / 11.0f) return (363 / 40.0f * t * t) - (99 / 10.0f * t) + 17 / 5.0f;
            if (t < 9 / 10.0f) return (4356 / 361.0f * t * t) - (35442 / 1805.0f * t) + 16061 / 1805.0f;
